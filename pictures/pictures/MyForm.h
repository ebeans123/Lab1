...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(26, 426);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(137, 426);
			...
			this->ClientSize = System::Drawing::Size(836, 472);
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) 
	{
		//get graphic
		System::Drawing::Graphics^ g = pictureBox1->CreateGraphics();
		Bitmap^ bmp = gcnew Bitmap(L"Capture.bmp");
		g->DrawImage(bmp, 0, 0);
	}
};
}
